...
echo_and_run cd "/home/tim/FDMPrinting/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/tim/FDMPrinting/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/tim/FDMPrinting/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
