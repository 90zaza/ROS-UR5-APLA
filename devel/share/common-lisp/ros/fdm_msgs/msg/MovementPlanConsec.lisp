...
(cl:defclass <MovementPlanConsec> (roslisp-msg-protocol:ros-message)
  ((seq_ids
    :reader seq_ids
    :initarg :seq_ids
...
(cl:defclass MovementPlanConsec (<MovementPlanConsec>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MovementPlanConsec>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MovementPlanConsec)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fdm_msgs-msg:<MovementPlanConsec> is deprecated: use fdm_msgs-msg:MovementPlanConsec instead.")))

(cl:ensure-generic-function 'seq_ids-val :lambda-list '(m))
(cl:defmethod seq_ids-val ((m <MovementPlanConsec>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fdm_msgs-msg:seq_ids-val is deprecated.  Use fdm_msgs-msg:seq_ids instead.")
  (seq_ids m))

(cl:ensure-generic-function 'timestamps-val :lambda-list '(m))
(cl:defmethod timestamps-val ((m <MovementPlanConsec>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fdm_msgs-msg:timestamps-val is deprecated.  Use fdm_msgs-msg:timestamps instead.")
  (timestamps m))

(cl:ensure-generic-function 'trajectory-val :lambda-list '(m))
(cl:defmethod trajectory-val ((m <MovementPlanConsec>))
  ...
  (trajectory m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MovementPlanConsec>) ostream)
  "Serializes a message object of type '<MovementPlanConsec>"
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'seq_ids))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MovementPlanConsec>) istream)
  "Deserializes a message object of type '<MovementPlanConsec>"
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'seq_ids) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'seq_ids)))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MovementPlanConsec>))
  "Converts a ROS message object to a list"
  (cl:list 'MovementPlanConsec
    (cl:cons ':seq_ids (seq_ids msg))
